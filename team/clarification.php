...
if (isset($id)) {
    ...
    echo '</div><div class="mt-3"><button class="btn btn-secondary btn-sm" data-toggle="collapse" data-target="#collapsereplyform" aria-expanded="false" aria-controls="collapsereplyform">回复本条内容</button></div>';
    echo "</div>";
