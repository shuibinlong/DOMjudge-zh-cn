...
<?php if ($started): ?>
      <div id="submitbut"><a class="nav-link justify-content-center" href="submit.php"><button type="button" class="btn btn-success btn-sm"><span class="octicon octicon-cloud-upload"></span> 提交代码</button></a></div>
<?php else: ?>
